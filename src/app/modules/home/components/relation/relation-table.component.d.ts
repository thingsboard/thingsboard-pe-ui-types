...
export declare class RelationTableComponent extends PageComponent implements AfterViewInit, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<RelationTableComponent, "tb-relation-table", never, { "active": "active"; "entityId": "entityId"; "readonly": "readonly"; }, {}, never, never, false>;
}
