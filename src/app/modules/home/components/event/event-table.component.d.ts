...
export declare class EventTableComponent implements OnInit, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<EventTableComponent, "tb-event-table", never, { "tenantId": "tenantId"; "defaultEventType": "defaultEventType"; "disabledEventTypes": "disabledEventTypes"; "debugEventTypes": "debugEventTypes"; "active": "active"; "entityId": "entityId"; }, {}, never, never>;
}
