...
export declare class AliasesEntitySelectComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AliasesEntitySelectComponent, "tb-aliases-entity-select", never, { "aliasController": "aliasController"; "tooltipPosition": "tooltipPosition"; "disabled": "disabled"; }, {}, never, never, false, never>;
}
