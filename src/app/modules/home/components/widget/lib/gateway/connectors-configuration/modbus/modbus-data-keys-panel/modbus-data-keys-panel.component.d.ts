...
export declare class ModbusDataKeysPanelComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ModbusDataKeysPanelComponent, "tb-modbus-data-keys-panel", never, { "isMaster": { "alias": "isMaster"; "required": false; }; "hideNewFields": { "alias": "hideNewFields"; "required": false; }; "panelTitle": { "alias": "panelTitle"; "required": false; }; "addKeyTitle": { "alias": "addKeyTitle"; "required": false; }; "deleteKeyTitle": { "alias": "deleteKeyTitle"; "required": false; }; "noKeysText": { "alias": "noKeysText"; "required": false; }; "keysType": { "alias": "keysType"; "required": false; }; "values": { "alias": "values"; "required": false; }; "popover": { "alias": "popover"; "required": false; }; }, { "keysDataApplied": "keysDataApplied"; }, never, never, true, never>;
}
