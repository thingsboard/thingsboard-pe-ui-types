...
export declare class AlarmFilterPanelComponent {
    ...
    constructor(data: AlarmFilterPanelData, overlayRef: OverlayRef, fb: FormBuilder);
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AlarmFilterPanelComponent, "tb-alarm-filter-panel", never, {}, {}, never, never>;
}
