...
export declare class RouteMapSettingsComponent extends PageComponent implements OnInit, ControlValueAccessor, Validator {
    ...
    routeMapSettingsFormGroup: FormGroup;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<RouteMapSettingsComponent, "tb-route-map-settings", never, { "disabled": "disabled"; }, {}, never, never>;
}
