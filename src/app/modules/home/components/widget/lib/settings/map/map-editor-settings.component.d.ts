...
export declare class MapEditorSettingsComponent extends PageComponent implements OnInit, ControlValueAccessor, Validator {
    ...
    mapEditorSettingsFormGroup: FormGroup;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MapEditorSettingsComponent, "tb-map-editor-settings", never, { "disabled": "disabled"; }, {}, never, never>;
}
