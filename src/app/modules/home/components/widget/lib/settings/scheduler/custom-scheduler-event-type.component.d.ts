...
export declare class CustomSchedulerEventTypeComponent extends PageComponent implements OnInit, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CustomSchedulerEventTypeComponent, "tb-custom-scheduler-event-type", never, { "disabled": { "alias": "disabled"; "required": false; }; "expanded": { "alias": "expanded"; "required": false; }; }, { "removeCustomSchedulerEventType": "removeCustomSchedulerEventType"; }, never, never, false, never>;
}
