...
export declare class CommonMapSettingsComponent extends PageComponent implements OnInit, ControlValueAccessor, Validator, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CommonMapSettingsComponent, "tb-common-map-settings", never, { "disabled": "disabled"; "provider": "provider"; "widget": "widget"; }, {}, never, never, false>;
}
