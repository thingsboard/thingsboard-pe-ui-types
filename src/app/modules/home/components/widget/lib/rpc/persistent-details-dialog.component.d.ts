...
export declare class PersistentDetailsDialogComponent extends DialogComponent<PersistentDetailsDialogComponent, boolean> implements OnInit {
    ...
    persistentFormGroup: FormGroup;
    rpcStatusColorsMap: Map<RpcStatus, string>;
    rpcStatus: typeof RpcStatus;
    allowDelete: boolean;
    private persistentUpdated;
    private responseData;
    constructor(store: Store<AppState>, router: Router, datePipe: DatePipe, translate: TranslateService, data: PersistentDetailsDialogData, dialogRef: MatDialogRef<PersistentDetailsDialogComponent, boolean>, dialogService: DialogService, deviceService: DeviceService, fb: FormBuilder);
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PersistentDetailsDialogComponent, "tb-persistent-details-dialog", never, {}, {}, never, never>;
}
