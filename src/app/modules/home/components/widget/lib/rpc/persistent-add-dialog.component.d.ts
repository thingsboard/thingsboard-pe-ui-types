...
export declare class PersistentAddDialogComponent extends DialogComponent<PersistentAddDialogComponent, RequestData> implements OnInit {
    ...
    private requestData;
    constructor(store: Store<AppState>, router: Router, dialogRef: MatDialogRef<PersistentAddDialogComponent, RequestData>, fb: FormBuilder, translate: TranslateService);
    save(): void;
    ngOnInit(): void;
    close(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<PersistentAddDialogComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<PersistentAddDialogComponent, "tb-persistent-add-dialog", never, {}, {}, never, never>;
}
