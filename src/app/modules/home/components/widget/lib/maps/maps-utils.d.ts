...
export declare function createTooltip(target: L.Layer, settings: MarkerSettings | PolylineSettings | PolygonSettings, datasource: Datasource, autoClose?: boolean, showTooltipAction?: string, content?: string | HTMLElement): L.Popup;
