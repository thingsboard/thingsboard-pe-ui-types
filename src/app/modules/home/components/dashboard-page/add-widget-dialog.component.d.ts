...
export declare class AddWidgetDialogComponent extends DialogComponent<AddWidgetDialogComponent, Widget> implements OnInit, ErrorStateMatcher {
    ...
    widget: Widget;
    submitted: boolean;
    constructor(store: Store<AppState>, router: Router, data: AddWidgetDialogData, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<AddWidgetDialogComponent, Widget>, fb: FormBuilder);
    ngOnInit(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AddWidgetDialogComponent, "tb-add-widget-dialog", never, {}, {}, never, never>;
}
