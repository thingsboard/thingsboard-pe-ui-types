...
export declare class DashboardToolbarComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DashboardToolbarComponent, "tb-dashboard-toolbar", never, { "toolbarOpened": "toolbarOpened"; "forceFullscreen": "forceFullscreen"; }, { "triggerClick": "triggerClick"; }, never, ["*"]>;
}
