...
export declare class DashboardSettingsDialogComponent extends DialogComponent<DashboardSettingsDialogComponent, DashboardSettingsDialogData> implements OnInit, ErrorStateMatcher {
    ...
    submitted: boolean;
    constructor(store: Store<AppState>, router: Router, data: DashboardSettingsDialogData, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<DashboardSettingsDialogComponent, DashboardSettingsDialogData>, fb: FormBuilder, utils: UtilsService, dashboardUtils: DashboardUtilsService, translate: TranslateService, statesControllerService: StatesControllerService);
    ngOnInit(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DashboardSettingsDialogComponent, "tb-dashboard-settings-dialog", never, {}, {}, never, never>;
}
