...
export declare abstract class EntityTabsComponent<T extends BaseData<HasId>, P extends PageLink = PageLink, L extends BaseData<HasId> = T, C extends EntityTableConfig<T, P, L> = EntityTableConfig<T, P, L>> extends PageComponent implements OnInit, AfterViewInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<EntityTabsComponent<any, any, any, any>, never, never, { "isEdit": { "alias": "isEdit"; "required": false; }; "entity": { "alias": "entity"; "required": false; }; "entitiesTableConfig": { "alias": "entitiesTableConfig"; "required": false; }; "detailsForm": { "alias": "detailsForm"; "required": false; }; }, {}, never, never, true, never>;
}
