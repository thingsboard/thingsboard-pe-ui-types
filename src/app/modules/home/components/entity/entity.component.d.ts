...
export declare abstract class EntityComponent<T extends BaseData<HasId>, P extends PageLink = PageLink, L extends BaseData<HasId> = T, C extends EntityTableConfig<T, P, L> = EntityTableConfig<T, P, L>> extends PageComponent implements OnInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<EntityComponent<any, any, any, any>, never, never, { "entitiesTableConfig": { "alias": "entitiesTableConfig"; "required": false; }; "isEdit": { "alias": "isEdit"; "required": false; }; "entity": { "alias": "entity"; "required": false; }; }, { "entityAction": "entityAction"; }, never, never, true, never>;
}
