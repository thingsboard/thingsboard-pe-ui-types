...
export declare class AddWidgetToDashboardDialogComponent extends DialogComponent<AddWidgetToDashboardDialogComponent, void> implements OnInit, ErrorStateMatcher {
    ...
    submitted: boolean;
    constructor(store: Store<AppState>, router: Router, data: AddWidgetToDashboardDialogData, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<AddWidgetToDashboardDialogComponent, void>, fb: FormBuilder, utils: UtilsService, dashboardUtils: DashboardUtilsService, dashboardService: DashboardService, itembuffer: ItemBufferService, dialog: MatDialog);
    ngOnInit(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AddWidgetToDashboardDialogComponent, "tb-add-widget-to-dashboard-dialog", never, {}, {}, never, never>;
}
