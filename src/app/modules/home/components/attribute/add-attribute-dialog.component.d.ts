...
export declare class AddAttributeDialogComponent extends DialogComponent<AddAttributeDialogComponent, boolean> implements OnInit, ErrorStateMatcher {
    ...
    submitted: boolean;
    isTelemetry: boolean;
    keyValidators: import("@angular/forms").ValidatorFn[];
    constructor(store: Store<AppState>, router: Router, data: AddAttributeDialogData, attributeService: AttributeService, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<AddAttributeDialogComponent, boolean>, fb: FormBuilder, translate: TranslateService);
    ngOnInit(): void;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<AddAttributeDialogComponent, [null, null, null, null, { skipSelf: true; }, null, null, null]>;
