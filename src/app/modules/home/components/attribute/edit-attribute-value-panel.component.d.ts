...
export declare class EditAttributeValuePanelComponent extends PageComponent implements OnInit, ErrorStateMatcher {
    ...
    result: any;
    submitted: boolean;
    constructor(store: Store<AppState>, data: EditAttributeValuePanelData, errorStateMatcher: ErrorStateMatcher, overlayRef: OverlayRef, fb: FormBuilder);
    ngOnInit(): void;
    isErrorState(control: FormControl | null, form: FormGroupDirective | NgForm | null): boolean;
    cancel(): void;
    update(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<EditAttributeValuePanelComponent, [null, null, { skipSelf: true; }, null, null]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<EditAttributeValuePanelComponent, "tb-edit-attribute-value-panel", never, {}, {}, never, never>;
}
