...
export declare class AlarmRuleConditionDialogComponent extends DialogComponent<AlarmRuleConditionDialogComponent, AlarmCondition> implements OnInit, ErrorStateMatcher {
    ...
    submitted: boolean;
    constructor(store: Store<AppState>, router: Router, data: AlarmRuleConditionDialogData, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<AlarmRuleConditionDialogComponent, AlarmCondition>, fb: FormBuilder, translate: TranslateService);
    ngOnInit(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AlarmRuleConditionDialogComponent, "tb-alarm-rule-condition-dialog", never, {}, {}, never, never>;
}
