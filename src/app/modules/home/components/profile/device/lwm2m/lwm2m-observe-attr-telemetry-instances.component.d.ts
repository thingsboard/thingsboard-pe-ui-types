...
export declare class Lwm2mObserveAttrTelemetryInstancesComponent implements ControlValueAccessor, Validator, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<Lwm2mObserveAttrTelemetryInstancesComponent, "tb-profile-lwm2m-observe-attr-telemetry-instances", never, { "required": "required"; "disabled": "disabled"; }, {}, never, never, false>;
}
