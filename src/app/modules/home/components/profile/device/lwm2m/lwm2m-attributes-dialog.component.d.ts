...
export declare class Lwm2mAttributesDialogComponent extends DialogComponent<Lwm2mAttributesDialogComponent, AttributesNameValueMap> implements ErrorStateMatcher {
    ...
    constructor(store: Store<AppState>, router: Router, data: Lwm2mAttributesDialogData, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<Lwm2mAttributesDialogComponent, AttributesNameValueMap>, fb: FormBuilder);
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<Lwm2mAttributesDialogComponent, "tb-lwm2m-attributes-dialog", never, {}, {}, never, never>;
}
