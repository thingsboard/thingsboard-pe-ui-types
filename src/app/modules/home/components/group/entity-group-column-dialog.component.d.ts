...
export declare class EntityGroupColumnDialogComponent extends DialogComponent<EntityGroupColumnDialogComponent, EntityGroupColumn> implements OnInit, ErrorStateMatcher {
    ...
    constructor(store: Store<AppState>, router: Router, data: EntityGroupColumnDialogData, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<EntityGroupColumnDialogComponent, EntityGroupColumn>, widgetService: WidgetService, fb: UntypedFormBuilder);
    ngOnInit(): void;
