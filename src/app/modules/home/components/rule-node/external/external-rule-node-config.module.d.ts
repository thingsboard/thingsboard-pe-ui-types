...
import * as i1 from "./sns-config.component";
import * as i2 from "./sqs-config.component";
import * as i3 from "./lambda-config.component";
import * as i4 from "./pubsub-config.component";
import * as i5 from "./kafka-config.component";
import * as i6 from "./mqtt-config.component";
import * as i7 from "./notification-config.component";
import * as i8 from "./rabbit-mq-config.component";
import * as i9 from "./rest-api-call-config.component";
import * as i10 from "./send-email-config.component";
