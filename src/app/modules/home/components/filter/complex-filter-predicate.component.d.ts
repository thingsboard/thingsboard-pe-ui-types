...
export declare class ComplexFilterPredicateComponent implements ControlValueAccessor, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ComplexFilterPredicateComponent, "tb-complex-filter-predicate", never, { "disabled": "disabled"; "valueType": "valueType"; "key": "key"; "displayUserParameters": "displayUserParameters"; "allowUserDynamicSource": "allowUserDynamicSource"; "onlyUserDynamicSource": "onlyUserDynamicSource"; }, {}, never, never>;
}
