...
export declare class FiltersEditComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FiltersEditComponent, "tb-filters-edit", never, { "aliasController": "aliasController"; "tooltipPosition": "tooltipPosition"; "disabled": "disabled"; }, {}, never, never>;
}
