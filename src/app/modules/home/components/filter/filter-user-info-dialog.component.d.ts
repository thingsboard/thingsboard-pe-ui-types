...
export declare class FilterUserInfoDialogComponent extends DialogComponent<FilterUserInfoDialogComponent, KeyFilterPredicateUserInfo> implements OnInit, ErrorStateMatcher {
    ...
    submitted: boolean;
    constructor(store: Store<AppState>, router: Router, data: FilterUserInfoDialogData, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<FilterUserInfoDialogComponent, KeyFilterPredicateUserInfo>, fb: FormBuilder, translate: TranslateService);
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FilterUserInfoDialogComponent, "tb-filter-user-info-dialog", never, {}, {}, never, never>;
}
