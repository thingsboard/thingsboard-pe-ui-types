...
export declare class BooleanFilterPredicateComponent implements ControlValueAccessor, Validator, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<BooleanFilterPredicateComponent, "tb-boolean-filter-predicate", never, { "disabled": "disabled"; "allowUserDynamicSource": "allowUserDynamicSource"; "onlyUserDynamicSource": "onlyUserDynamicSource"; }, {}, never, never, false>;
}
