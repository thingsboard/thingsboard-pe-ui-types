...
export declare class IbmWatsonIotIntegrationFormComponent extends IntegrationForm implements OnInit, ControlValueAccessor, Validator {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IbmWatsonIotIntegrationFormComponent, "tb-ibm-watson-iot-integration-form", never, { "isEdgeTemplate": { "alias": "isEdgeTemplate"; "required": false; }; }, {}, never, never, false, never>;
}
