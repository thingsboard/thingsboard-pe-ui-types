...
export declare class SnmpDeviceTransportConfigurationComponent implements ControlValueAccessor, OnInit, Validator {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SnmpDeviceTransportConfigurationComponent, "tb-snmp-device-transport-configuration", never, { "required": "required"; "disabled": "disabled"; }, {}, never, never, false>;
}
