...
export declare class MqttDeviceTransportConfigurationComponent implements ControlValueAccessor, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MqttDeviceTransportConfigurationComponent, "tb-mqtt-device-transport-configuration", never, { "required": "required"; "disabled": "disabled"; }, {}, never, never>;
}
