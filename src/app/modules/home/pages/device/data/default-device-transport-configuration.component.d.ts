...
export declare class DefaultDeviceTransportConfigurationComponent implements ControlValueAccessor, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DefaultDeviceTransportConfigurationComponent, "tb-default-device-transport-configuration", never, { "required": "required"; "disabled": "disabled"; }, {}, never, never, false>;
}
