...
export declare class Lwm2mDeviceTransportConfigurationComponent implements ControlValueAccessor, OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<Lwm2mDeviceTransportConfigurationComponent, "tb-lwm2m-device-transport-configuration", never, { "required": "required"; "disabled": "disabled"; }, {}, never, never, false>;
}
