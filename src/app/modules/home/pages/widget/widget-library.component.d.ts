...
export declare class WidgetLibraryComponent extends PageComponent implements OnInit {
    ...
    constructor(store: Store<AppState>, userPermissionsService: UserPermissionsService, route: ActivatedRoute, router: Router, widgetService: WidgetService, dialogService: DialogService, importExport: ImportExportService, dialog: MatDialog, translate: TranslateService, utils: UtilsService, entityService: EntityService);
    ngOnInit(): void;
