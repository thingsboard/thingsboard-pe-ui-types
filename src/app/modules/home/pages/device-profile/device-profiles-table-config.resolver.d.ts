...
export declare class DeviceProfilesTableConfigResolver {
    ...
    constructor(deviceProfileService: DeviceProfileService, importExport: ImportExportService, userPermissionsService: UserPermissionsService, translate: TranslateService, datePipe: DatePipe, dialogService: DialogService, utils: UtilsService, router: Router, dialog: MatDialog, customTranslate: CustomTranslatePipe);
