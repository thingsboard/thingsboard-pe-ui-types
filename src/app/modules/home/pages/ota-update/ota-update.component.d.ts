...
export declare class OtaUpdateComponent extends EntityComponent<OtaPackage> implements OnInit, OnDestroy {
    ...
    constructor(store: Store<AppState>, translate: TranslateService, entityValue: OtaPackage, entitiesTableConfigValue: EntityTableConfig<OtaPackage>, fb: FormBuilder, cd: ChangeDetectorRef);
    ngOnInit(): void;
    ngOnDestroy(): void;
    hideDelete(): boolean;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<OtaUpdateComponent, "tb-ota-update", never, {}, {}, never, never>;
}
