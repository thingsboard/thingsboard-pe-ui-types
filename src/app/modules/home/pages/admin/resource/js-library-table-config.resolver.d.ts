...
export declare class JsLibraryTableConfigResolver {
    ...
    constructor(store: Store<AppState>, resourceService: ResourceService, userPermissionsService: UserPermissionsService, translate: TranslateService, dialog: MatDialog, dialogService: DialogService, router: Router, datePipe: DatePipe);
