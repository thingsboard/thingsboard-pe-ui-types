...
import { TelemetryService } from '@shared/models/telemetry/telemetry.models';
...
export declare class GroupEntitiesDataSource extends EntitiesDataSource<ShortEntityView> {
    ...
    constructor(columns: EntityGroupColumn[], entityGroupId: string, groupType: EntityType, telemetryService: TelemetryService, zone: NgZone, selectionEnabledFunction: EntityBooleanFunction<ShortEntityView>, dataLoadedFunction: (col?: number, row?: number) => void);
