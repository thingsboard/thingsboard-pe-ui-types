...
export declare class AddEntitiesToEdgeDialogComponent extends DialogComponent<AddEntitiesToEdgeDialogComponent, boolean> implements OnInit, ErrorStateMatcher {
    ...
    constructor(store: Store<AppState>, router: Router, data: AddEntitiesToEdgeDialogData, ruleChainService: RuleChainService, schedulerEventService: SchedulerEventService, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<AddEntitiesToEdgeDialogComponent, boolean>, fb: FormBuilder);
    ngOnInit(): void;
    isErrorState(control: FormControl | null, form: FormGroupDirective | NgForm | null): boolean;
    cancel(): void;
    assign(): void;
    private getAssignToEdgeTask;
    static ɵfac: i0.ɵɵFactoryDeclaration<AddEntitiesToEdgeDialogComponent, [null, null, null, null, null, { skipSelf: true; }, null, null]>;
