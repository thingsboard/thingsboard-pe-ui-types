...
export declare class ShareEntityGroupDialogComponent extends DialogComponent<ShareEntityGroupDialogComponent, boolean> implements OnInit, ErrorStateMatcher {
    ...
    entityGroupId: EntityGroupId;
    submitted: boolean;
    constructor(store: Store<AppState>, router: Router, data: ShareEntityGroupDialogData, dialogRef: MatDialogRef<ShareEntityGroupDialogComponent, boolean>, errorStateMatcher: ErrorStateMatcher, entityGroupService: EntityGroupService, fb: UntypedFormBuilder);
    ngOnInit(): void;
