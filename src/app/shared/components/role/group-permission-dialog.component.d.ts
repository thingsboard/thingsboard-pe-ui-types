...
export declare class GroupPermissionDialogComponent extends DialogComponent<GroupPermissionDialogComponent, boolean | GroupPermission> implements OnInit, ErrorStateMatcher {
    ...
    submitted: boolean;
    constructor(store: Store<AppState>, router: Router, data: GroupPermissionDialogData, roleService: RoleService, userPermissionsService: UserPermissionsService, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<GroupPermissionDialogComponent, boolean | GroupPermission>, fb: FormBuilder);
    ngOnInit(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<GroupPermissionDialogComponent, "tb-group-permission-dialog", never, {}, {}, never, never>;
}
