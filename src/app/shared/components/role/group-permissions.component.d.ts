...
export declare class GroupPermissionsComponent extends PageComponent implements AfterViewInit, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<GroupPermissionsComponent, "tb-group-permissions", never, { "active": "active"; "entityGroup": "entityGroup"; "registrationPermissions": "registrationPermissions"; "readonly": "readonly"; }, { "permissionsChanged": "permissionsChanged"; }, never, never>;
}
