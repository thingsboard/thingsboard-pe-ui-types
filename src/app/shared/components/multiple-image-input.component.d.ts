...
export declare class MultipleImageInputComponent extends PageComponent implements AfterViewInit, OnDestroy, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MultipleImageInputComponent, "tb-multiple-image-input", never, { "label": "label"; "maxSizeByte": "maxSizeByte"; "required": "required"; "disabled": "disabled"; "inputId": "inputId"; }, {}, never, never>;
}
