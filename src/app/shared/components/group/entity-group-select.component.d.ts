...
export declare class EntityGroupSelectComponent implements ControlValueAccessor, OnInit, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<EntityGroupSelectComponent, "tb-entity-group-select", never, { "allowedGroupTypes": "allowedGroupTypes"; "excludeGroupTypes": "excludeGroupTypes"; "defaultGroupType": "defaultGroupType"; "excludeGroupIds": "excludeGroupIds"; "excludeGroupAll": "excludeGroupAll"; "placeholderText": "placeholderText"; "notFoundText": "notFoundText"; "requiredText": "requiredText"; "ownerId": "ownerId"; "originator": "originator"; "required": "required"; "disabled": "disabled"; }, { "currentGroupType": "currentGroupType"; "currentGroupInfo": "currentGroupInfo"; }, never, never, false, never>;
}
