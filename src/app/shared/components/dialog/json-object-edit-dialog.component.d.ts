...
export declare class JsonObjectEditDialogComponent extends DialogComponent<JsonObjectEditDialogComponent, object> implements OnInit {
    ...
    title: string;
    submitted: boolean;
    constructor(store: Store<AppState>, router: Router, data: JsonObjectEditDialogData, dialogRef: MatDialogRef<JsonObjectEditDialogComponent, object>, fb: UntypedFormBuilder, translate: TranslateService);
    ngOnInit(): void;
    cancel(): void;
    add(): void;
