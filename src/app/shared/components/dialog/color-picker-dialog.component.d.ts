...
export declare class ColorPickerDialogComponent extends DialogComponent<ColorPickerDialogComponent, string> implements OnInit, ErrorStateMatcher {
    ...
    submitted: boolean;
    constructor(store: Store<AppState>, router: Router, data: ColorPickerDialogData, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<ColorPickerDialogComponent, string>, fb: FormBuilder);
    ngOnInit(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ColorPickerDialogComponent, "tb-color-picker-dialog", never, {}, {}, never, never>;
}
