...
export declare class DatetimeComponent implements OnInit, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatetimeComponent, "tb-datetime", never, { "required": "required"; "disabled": "disabled"; "dateText": "dateText"; "timeText": "timeText"; "showLabel": "showLabel"; "minDate": "minDate"; "maxDate": "maxDate"; }, {}, never, never>;
}
