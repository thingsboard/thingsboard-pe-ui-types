...
export declare class QuickTimeIntervalComponent implements OnInit, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<QuickTimeIntervalComponent, "tb-quick-time-interval", never, { "disabled": "disabled"; "onlyCurrentInterval": "onlyCurrentInterval"; }, {}, never, never, false, never>;
}
