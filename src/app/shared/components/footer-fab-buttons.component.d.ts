...
export declare class FooterFabButtonsComponent extends PageComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FooterFabButtonsComponent, "tb-footer-fab-buttons", never, { "footerFabButtons": "footerFabButtons"; "relative": "relative"; }, {}, never, never>;
}
