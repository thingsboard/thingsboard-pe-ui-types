...
export declare class FabToolbarComponent extends MatFabToolbarBase implements OnInit, OnDestroy, AfterViewInit, OnChanges {
    private el;
    private window;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FabToolbarComponent, "mat-fab-toolbar", never, { "isOpen": { "alias": "isOpen"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "color": { "alias": "color"; "required": false; }; "defaultColor": { "alias": "defaultColor"; "required": false; }; }, {}, never, ["*"], false, never>;
}
export {};
