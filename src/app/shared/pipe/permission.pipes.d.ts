...
export declare class HasGenericPermissionPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<HasGenericPermissionPipe, "hasGenericPermission">;
}
export declare class HasEntityGroupPermissionPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<HasEntityGroupPermissionPipe, "hasEntityGroupPermission">;
}
export declare class HasGroupEntityPermissionPipe implements PipeTransform {
    ...
    static ɵpipe: i0.ɵɵPipeDeclaration<HasGroupEntityPermissionPipe, "hasGroupEntityPermission">;
}
