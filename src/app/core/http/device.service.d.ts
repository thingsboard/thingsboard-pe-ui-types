...
import { ClaimRequest, ClaimResult, Device, DeviceCredentials, DeviceSearchQuery } from '@app/shared/models/device.models';
...
export declare class DeviceService {
    ...
    saveDevice(device: Device, entityGroupId?: string, config?: RequestConfig): Observable<Device>;
