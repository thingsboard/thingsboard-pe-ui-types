...
import { Converter, ConverterDebugInput, LatestConverterParameters, TestConverterResult, TestDownLinkInputParams, TestUpLinkInputParams } from '@shared/models/converter.models';
